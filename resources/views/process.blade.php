							...
							<div id="confirm_area" class="mgt20">
								...
								@else
									...
									<!--<div><button class="gc3 transition1 " type="button" onClick="clickEvent('updateform','{{ $product_code }}','','upprocessdetails','『 工程確定済 』','process_status_rec','')">工程確定済</button></div>-->
										...
										@elseif($status == "1")
											<div class="btn_result gc10">終了</div><button class="btn_button transition1 " type="button" onClick="clickEvent('updateform','{{ $product_code }}','0','upprocessdetails','『 終了を取り消し 』','process_status_change','')">終了取消</button>
										@else
